...
#include <SerialCommand.h>                          // library from universiteit antwerpen, NOT arduino self
...
Stepper myStepper1(stepsPerRevolution, 8, 10, 9, 11); //1-3-2-4
Stepper myStepper2(stepsPerRevolution, 4, 6, 5, 7);  // 1-3-2-4
